...
from ailib import Chain, ChainStep, Message, Role
...
class TestChain:
    ...
    def test_chain_with_processor(self):
        ...
        # Create and run chain
        chain = (Chain(mock_llm)
            .add_user("What is 40 + 2?", processor=to_int)
        )
    ...
    def test_chain_multi_step(self):
        ...
        chain = (Chain(mock_llm)
            ...
            .add_user("How many people live in {capital_query}?", name="population_query")
        )
