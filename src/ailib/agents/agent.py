...
class Agent:
    ...
    def with_tools(self, *tools: Union[Tool, Callable]) -> "Agent":
    ...
    def _create_system_prompt(self) -> str:
        ...
        return f"""You are a helpful AI assistant that can use tools to answer questions and complete tasks.
        ...
        while steps < self.max_steps:
            ...
            if parsed["action"]:
                ...
                messages.append(Message(
                    role=Role.USER,
                    content="Please specify an Action (tool name or 'Final Answer') and Action Input."
                ))
        
        # Max steps reached
        return "I couldn't complete the task within the maximum number of steps. Please try breaking it down into smaller tasks."

    async def arun(self, task: str, session: Optional[Session] = None) -> str:
